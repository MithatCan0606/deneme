...
await member.setNickname(`⚚ ${isim} | ${yas}`)
  ...
  member.addRole('732942943664603186') // erkek 2
  member.addRole('732942944423641159') // erkek 3
  ...
  .setColor("BLACK")
  .addField(`Developer | Permisons`, `<a:venom:732944862890033233> ${member.user} **adlı üyeye** <@&${consts.man_role}> **rolünü verip ismini**  \`⚚ ${isim} | ${yas}\` **olarak ayarladım!**`)                                                                             
  .setFooter(message.author.tag ,message.author.avatarURL)
  .setTimestamp()
